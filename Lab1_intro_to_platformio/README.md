...
1. Carefully follow the steps written in the **[Lab 1: Introduction to Platform IO.md](Lab1_intro_to_platformio.md)** to setup a demo project using the XIAO ESP32C3 board that some of you have used for your wearables project. 
While the tutorial is specific to setting up the XIAO ESP32C3, the setup for most other boards is similar.
